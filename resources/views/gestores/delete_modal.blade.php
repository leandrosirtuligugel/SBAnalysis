{!! Form::open(['route' => ['gestores.destroy', 'codigogestor' => $gestor->codigogestor], 'method' => 'delete', 'id' => 'form-modal', 'autocomplete' => 'off']) !!}
...
<div class="modal-body">
	<p>Você tem certeza que quer excluir o gestor <b>{{ $gestor->nomegestor }}</b>?</p>
</div>
